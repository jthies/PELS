...
//        int invPermLen;
    ...
    public:
         ...
         * <TABLE>
         * <TR><TD>Type</TD><TD>Value</TD></TR>
         * <TR><TD>Close/Compact</TD><TD>RACE::FILL (default)</TD></TR>
         * <TR><TD>Scattered</TD><TD>RACE::SCATTER</TD></TR>
         * </TABLE>
         ...
         */
        Interface(int nrow_, int nthreads_, RACE::dist dist_, int *rowPtr_, int *col_, bool symm_hint=false, int SMT_=1, RACE::PinMethod method_=RACE::FILL, int *initPerm_=NULL, int *initInvPerm_=NULL, RACE::d2Method d2Type_=RACE::TWO_BLOCK, RACE::LBTarget lbTarget_=RACE::NNZ);
        ~Interface();
        //Pre-processing
        RACE_error RACEColor(int highestPower, double cacheSize, double safetyFactor=2, std::string mtxType="N", int highestSubPower=1);
        ...
        void findDkHalos(int k, int start_rows, int end_rows);
};
