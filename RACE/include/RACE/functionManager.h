...
class FuncManager
{
    private:
        ...
        inline void powerCallGeneralOneThread(int startLevel, int endLevel, int boundaryStart, int boundaryEnd, int startSlope, int endSlope, const std::vector<int> *levelPtr, const std::vector<std::map<int, std::vector<std::vector<int>>>>* boundaryLevelPtr, const std::vector<int> *unlockRow, const std::vector<std::map<int, std::vector<std::vector<int>>>>* boundaryUnlockRow, const std::vector<int> *unlockCtr, const std::vector<int> *dangerRow, const std::vector<std::map<int, std::vector<std::vector<int>>>>* boundaryDangerRow, int numaLocalArg, int offset, int parent);
        ...
        inline void powerCallHopelessRightReminderOneThread(int leftmostLevel, const std::vector<int> *levelPtr, const std::vector<std::map<int, std::vector<std::vector<int>>>>* boundaryLevelPtr, const std::vector<int> *unlockRow, const std::vector<int> *unlockCtr, const std::vector<int> *dangerRow, int numaLocalArg, int offset, int parent);
        ...
        inline void powerCallHopelessLeftReminderOneThread(int rightmostLevel, const std::vector<int> *levelPtr, const std::vector<std::map<int, std::vector<std::vector<int>>>>* boundaryLevelPtr, const std::vector<int> *unlockRow, const std::vector<int> *unlockCtr, const std::vector<int> *dangerRow, int numaLocalArg, int offset, int parent);
