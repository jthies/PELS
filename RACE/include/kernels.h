...
void gs(densemat* b, sparsemat* mat, densemat* x, bool rev=false);
void gs_serial(densemat* b, sparsemat* mat, densemat* x, bool rev=false);
void kacz(densemat* b, sparsemat* mat, densemat* x, bool rev=false);
void kacz_serial(densemat* b, sparsemat* mat, densemat* x, bool rev=false);
